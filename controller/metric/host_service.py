...
class host_service():
    ...
    def get_net_in_bytes(self, auth_token):
        return self.rs.request_post_st('hardware.network.incoming.bytes',auth_token, '2022-11-22T06:35:00')

    def get_net_out_bytes(self, auth_token):
        return self.rs.request_post_st('hardware.network.outgoing.bytes',auth_token,'2022-11-22T06:35:00')

    def get_disk_size_total(self, auth_token):
        return self.rs.request_post_st('hardware.disk.size.total', auth_token, '2022-11-22T06:35:00')  

    def get_disk_size_used(self, auth_token):
        return self.rs.request_post_st('hardware.disk.size.used', auth_token, '2022-11-22T06:35:00')                                                               